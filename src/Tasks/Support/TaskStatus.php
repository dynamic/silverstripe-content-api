 ...
 * both branch `2` (SS6) and branch `1`, so a test asserting on
 ...
 * this branch's composer.json doesn't require it directly, and a `use`
 * import for a package outside a branch's real dependency tree fails that
 * branch's own PHPStan run even if the method is never called. Branch `2`'s
