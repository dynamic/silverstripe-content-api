 ...
 * Written to be byte-identical when this branch adopted the same
 * `ServiceAccountProvisioner`; each
...
class ServiceAccountProvisionerTest extends SapphireTest
{
    ...
    public function testRefusesToGuessWhenMultipleGroupsShareTheTitle(): void
    {
        ...
        // SetupServiceAccountTaskTest's equivalent test), but this branch's doesn't —
